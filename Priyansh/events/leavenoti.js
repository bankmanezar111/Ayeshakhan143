...
(typeof data.customLeave == "undefined") ? msg = "𝐖𝐞𝐥𝐜𝐨𝐦𝐞 𝐓𝐨  𝐊𝐡𝐚𝐧 𝐒𝐚𝐡𝐚𝐛  𝐁𝐨𝐭 😇👈 ●============================●  [⚜️] •💜• === {name} === •💜• ●============================● KO Bhaga diya 🌝 ●============================● 𝐀𝐛 𝐔𝐬𝐤𝐞 𝐁𝐢𝐧𝐚 𝐊𝐞𝐬𝐞 𝐌𝐚𝐧 𝐋𝐚𝐠𝐞𝐠𝐚 𝐌𝐞𝐫𝐚🥺🥺🥺 •💜• {type}  [⚜️] ●============================● 𝙃𝘼𝙈 𝙒𝙊 𝙃𝘼𝙄 𝙅𝙉𝘼𝘼𝘽 𝙅𝙊 𝘽𝘼𝘼𝙏 𝙎𝙀 𝙅𝘼𝘼𝙏 𝙊𝙍 𝙃𝘼𝙍𝙆𝙏𝙊 𝙎𝙀 𝙊𝙆𝘼𝘼𝙏 𝙉𝘼𝘼𝙋 𝙇𝙀𝙏𝙀 𝙃𝘼𝙄😎😎\n😒 𝐀𝐀𝐏𝐊𝐀 𝐀𝐏𝐍𝐀 (𝐎𝐰𝐧𝐞𝐫) ➻  ────  𝐊𝐡𝐚𝐧 𝐒𝐚𝐡𝐚𝐛 😒\n●============================● •💜• {name} •💜• ●============================● •💜• BEHTI HAWA SA THAA WO 😥 uDTI PATANG✨✨ SAA THAA WOO ♥ KAHA GAYA USE DHOONDHO🤔🤔🤔 ●============================● •💜•\n\n[❤️‍🔥] 🖤🖤😥😥...Good {session} || {time}" : msg = data.customLeave;
